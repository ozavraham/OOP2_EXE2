...
// Assignment //
Writing program which recivieng input array from the user (Integer or String)and sending it to Generic HeapSort class.
HeapSort class "creating" Heap from the givven array, and sorting it according to the algorithm.
